...
impl ColumbusData {
    ...
    pub fn crime() -> Vec<f64> {
        vec![
            15.1, 10.0, 18.8, 4.3, 12.3, 9.6, 14.4, 48.8, 42.6, 32.0, 26.0, 25.5, 43.1, 29.6, 7.5,
            11.9, 8.7, 6.2, 9.3, 11.8, 12.1, 9.0, 7.1, 10.6, 14.4, 12.2, 2.6, 10.9, 32.8, 8.3, 3.3,
            21.7, 20.2, 21.0, 20.9, 29.8, 14.7, 5.6, 9.6, 9.7, 11.0, 12.7, 15.9, 17.9, 8.4, 6.7,
            9.6, 25.5, 18.4,
        ]
    }
    ...
    pub fn income() -> Vec<f64> {
        vec![
            9.6, 21.2, 13.6, 20.7, 15.4, 14.4, 6.0, 13.0, 13.3, 12.0, 8.4, 9.3, 8.2, 9.9, 21.4,
            18.0, 17.0, 18.2, 16.9, 15.9, 15.8, 17.9, 18.9, 18.4, 9.8, 9.5, 19.4, 11.7, 6.5, 17.6,
            19.7, 9.0, 5.2, 11.5, 9.8, 5.4, 19.0, 21.2, 15.4, 7.6, 11.3, 9.1, 3.9, 6.5, 13.1, 15.3,
            12.5, 8.8, 9.2,
        ]
    }
    ...
    pub fn housing_value() -> Vec<f64> {
        vec![
            80.5, 161.0, 101.0, 156.0, 120.0, 101.0, 48.8, 67.0, 73.0, 75.0, 84.0, 73.0, 56.0,
            78.0, 147.0, 143.0, 137.0, 137.0, 138.0, 139.0, 141.0, 141.0, 138.0, 140.0, 123.0,
            122.0, 169.0, 119.0, 47.0, 119.0, 176.0, 95.0, 64.0, 87.0, 86.0, 56.0, 155.0, 169.0,
            143.0, 62.0, 117.0, 111.0, 28.0, 65.0, 124.0, 138.0, 127.0, 80.0, 90.0,
        ]
    }
