...
pub fn lidar_tool_param_schemas(tool_id: &str) -> Option<BTreeMap<String, ToolParamSchema>> {
    match tool_id {
        ...
        "lidar_point_stats" => Some(param_schema_map(&[
            ...
            ("resolution", ToolParamSchema::scalar_float_min(0.0)),
        ...
        | "lidar_segmentation_based_filter" => Some(param_schema_map(&[
            ...
            ("min_height", ToolParamSchema::scalar_float()),
            ("max_height", ToolParamSchema::scalar_float()),
            ("bandwidth_min", ToolParamSchema::scalar_float_gt(0.0)),
            ("bandwidth_max", ToolParamSchema::scalar_float_gt(0.0)),
            ...
            ("search_radius", ToolParamSchema::scalar_float_min(0.0)),
            ("num_iterations", ToolParamSchema::scalar_integer_min(1)),
