...
pub fn remote_sensing_tool_param_schemas(
    tool_id: &str,
    ...
    match tool_id {
        ...
        "mosaic" => Some(param_schema_map(&[
            ...
            (
                ...
                ToolParamSchema::enum_values(&[
                    "nearest", "bilinear", "cubic", "lanczos", "average", "min", "max", "mode",
                    "median", "stddev",
                ]),
            ),
        ...
        "k_means_clustering" => Some(param_schema_map(&[
            ...
            (
                "out_html",
                ToolParamSchema::output(wbcore::ToolDatasetSchema::Text),
            ),
            ("output", ToolParamSchema::output_raster()),
        ])),
