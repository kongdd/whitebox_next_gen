...
pub fn geomorphometry_tool_param_schemas(
    ...
    match tool_id {
        ...
        | "casorati_curvature" => Some(param_schema_map(&[
        ...
        "hillshade" => Some(param_schema_map(&[
            ("dem", ToolParamSchema::input_raster()),
            ("azimuth", ToolParamSchema::scalar_azimuth()),
            ("altitude", ToolParamSchema::scalar_altitude()),
            ("z_factor", ToolParamSchema::scalar_float_min(0.0)),
            ("output", ToolParamSchema::output_raster()),
        ])),
        "multidirectional_hillshade" => Some(param_schema_map(&[
            ("dem", ToolParamSchema::input_raster()),
            ("altitude", ToolParamSchema::scalar_altitude()),
            ("z_factor", ToolParamSchema::scalar_float_min(0.0)),
        ...
        "percent_elev_range" | "relative_topographic_position" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
        ...
        "max_downslope_elev_change" | "max_upslope_elev_change" | "min_downslope_elev_change" => {
            Some(param_schema_map(&[
                ("input", ToolParamSchema::input_raster()),
                ("output", ToolParamSchema::output_raster()),
            ]))
        ...
        "saga_wetness_index" => Some(param_schema_map(&[
            ("dem", ToolParamSchema::input_raster()),
            ("suction", ToolParamSchema::scalar_float()),
            ("slope_min", ToolParamSchema::scalar_float()),
            ("z_factor", ToolParamSchema::scalar_float_gt(0.0)),
            (
                "output",
                ToolParamSchema::output(wbcore::ToolDatasetSchema::File),
        ...
        "max_difference_from_mean" | "max_anisotropy_dev" | "multiscale_roughness" => {
            Some(param_schema_map(&[
                ("input", ToolParamSchema::input_raster()),
                ("min_scale", ToolParamSchema::scalar_float_gt(0.0)),
                ("max_scale", ToolParamSchema::scalar_float_gt(0.0)),
        ...
        "multiscale_elevation_percentile" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
            ("min_scale", ToolParamSchema::scalar_float_gt(0.0)),
            ("num_steps", ToolParamSchema::scalar_integer_min(1)),
            ("step_size", ToolParamSchema::scalar_float_gt(0.0)),
            ("step_nonlinearity", ToolParamSchema::scalar_float_gt(0.0)),
            ("sig_digits", ToolParamSchema::scalar_integer()),
            ("output", ToolParamSchema::output_raster()),
            ("output_scale", ToolParamSchema::output_raster()),
        ])),
        "multiscale_std_dev_normals" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
            ("min_scale", ToolParamSchema::scalar_float_gt(0.0)),
            ("step", ToolParamSchema::scalar_float_min(0.0)),
            ("num_steps", ToolParamSchema::scalar_integer_min(1)),
            ("step_nonlinearity", ToolParamSchema::scalar_float_gt(0.0)),
            ("z_factor", ToolParamSchema::scalar_float_gt(0.0)),
            ("output", ToolParamSchema::output_raster()),
        ...
        "max_elev_dev_signature" | "max_anisotropy_dev_signature" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
            (
                "points",
                ToolParamSchema::input_vector(ToolVectorGeometry::Point),
        ...
        "multiscale_elevated_index" | "multiscale_low_lying_index" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
            ("min_scale", ToolParamSchema::scalar_float_gt(0.0)),
            ("step_size", ToolParamSchema::scalar_float_gt(0.0)),
            ("num_steps", ToolParamSchema::scalar_integer_min(1)),
        ...
        "contours_from_raster" => Some(param_schema_map(&[
            ("input", ToolParamSchema::input_raster()),
            ("interval", ToolParamSchema::scalar_float_min(0.0)),
            ("base", ToolParamSchema::scalar_float_min(0.0)),
            ("smooth", ToolParamSchema::scalar_integer_min(1)),
...
pub use terrain_analysis_tools::SagaWetnessIndexTool;
